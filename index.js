...
console.log(color(figlet.textSync('brynzx Bot-MD', {
		font: 'Pagga',
...
console.log(color('🐶 WA NUMBER: +6282211991425 ','silver'))
console.log(color('  Brynzx Bot Inc. 2022🦄','mediumseagreen'))
    ...
    console.log(color('🐶', 'cyan'), color('https://wa.me/6282211991425'))
    console.log(color('🐶', 'cyan'), color('Brynzx Bot Is Online...', 'pink'))
...
XeonBotInc.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
                    ...
                    let unicorndoc = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6282211991425-1623755519@g.us"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'xeon', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
                    xeonbody = `┌─❖
│「 𝗚𝗼𝗼𝗱𝗯𝘆𝗲 👋 」
└┬❖ 「 @${xeonName.split("@")[0]}  」
   │✑  𝗟𝗲𝗳𝘁 
